  ...
  patterns: [
    {
      ...
      forbiddenPatterns: ["formatAs", "export"],
    ...
    },
    {
      ...
      forbiddenPatterns: ["fetch", "FileWriter", "exportTo"],
    ...
    },
    {
      ...
      forbiddenPatterns: ["fetch", "format(List"],
    ...
    },
    {
      ...
      description: "ReportGenerator delegates to the three extracted classes",
    },
  ],
  compile: {
    files: [
